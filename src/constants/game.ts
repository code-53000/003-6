...
export const COLORS = {
  ...
  TRAIN_WHEEL: '#2c3e50',
  CHIMNEY: '#7f8c8d',
  GHOST_TRAIN_HEAD: 'rgba(230, 126, 34, 0.4)',
  GHOST_TRAIN_HEAD_DARK: 'rgba(211, 84, 0, 0.4)',
  GHOST_TRAIN_BODY: 'rgba(192, 57, 43, 0.4)',
  GHOST_TRAIN_BODY_DARK: 'rgba(169, 50, 38, 0.4)',
  GHOST_TRAIN_WINDOW: 'rgba(241, 196, 15, 0.4)',
  GHOST_TRAIN_WHEEL: 'rgba(44, 62, 80, 0.4)',
  GHOST_CHIMNEY: 'rgba(127, 140, 141, 0.4)',
